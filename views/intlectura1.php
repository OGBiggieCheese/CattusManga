...
if (isset($_GET['manga']) == NULL || isset($_GET['capitulo']) == NULL){ echo "No disponible"; }
...
<div class="container mangaint">

    <?php
    $count = count(glob("../mangas/$_GET[manga]/$_GET[capitulo]/*.jpg"));
    ?>
    <div class="container">
        <div class="row row-cols-1 d-flex justify-content-center mangapdf">
                <div class="d-flex fill">

                <div class="col-6 align-self-stretch col-md-6 d-flex page" onclick="prevPage()"></div>
                <div class="col-6 align-self-stretch col-md-6 d-flex page1" onclick="nextPage()"></div> 
                <img id="pagina" class="paginapc" src="../mangas/<?php echo $_GET['manga'] ?>/<?php echo $_GET['capitulo'] ?>/1.jpg">
...
if( isMobile.any() ){ 
    ...
    <div class="d-flex justify-content-center">
        <a href="intlectura.php?manga=<?php echo $_GET['manga']; ?>#chapters"><i class="bi bi-list" style=""></i></a>
        <p id="pagtext"> Pagina 1 de <?php echo $count ?></p>
    </div>
    ...
    <script type="application/javascript">
        ...
        if ($_GET['capitulo'] == $mangachapters[0]['number']) { 
        ?>
        ...
        <?php } else { ?>
            ...
            function maxlimiter() {
                if (lastpage == currentpage) {
                    window.location.href = 'intlectura1.php?manga=<?php echo $_GET['manga']; ?>&capitulo=<?php echo $_GET['capitulo'] + 1; ?>';
                }
            }
...
<div class="container">
    ...
    <?php if (isset($_SESSION['datos'])) { ?>
            ...
            <div class="card-body py-3 border-0">
                <div class="d-flex flex-start w-100">
                    ...
                    <div class="form-outline w-100">
                        <form method="post" id="comentar" oninput="activate()" action="manga/comentar.php?manga=<?php echo $_GET['manga'] ?>&capitulo=<?php echo $_GET['capitulo'] ?>">
        ...
        <?php } else { ?>
            <br>
            <a class="text-primary" href="login.php">Inicia sesion para comentar!</a>
        <?php }; ?>
        </div>
</div>
</div>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h1 class="modal-title fs-5" id="report">Reportar comentario</h1>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                        </div>
                                                        <div class="modal-body">
                                                            <p>Danos más información para procesar al comentario:</p>
                                                            <form action="../controllers/manga/reportarcom.php?user=<?php echo $row['ID'] ?>&id=<?php echo $row['c_ID'] ?>" method="POST">
